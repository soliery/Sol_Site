...
const CONTENT_DATA = {
  "/factorio": {
    ...
    videos: [
      { title: "Factorio Project", video: "https://youtube.com", description: "Example sound design work for Factorio." },
    ]
  },
  "/king-of-meat": {
    intro: "Briefly describe your work on King of Meat here.",
    videos: [
      { title: "King of Meat Trailer", video: "https://youtube.com", description: "Trailer audio production." }
    ]
  },
  "/redesigns": {
    intro: "Briefly describe your redesign projects here.",
    videos: [
      { title: "Sound Redesign Case", video: "https://youtube.com", description: "Full audio replacement study." }
    ]
  },
  "/advertising": {
  ...
  "/music": {
    ...
    videos: [
      { title: "Orchestral Piece", video: "https://youtube.com", description: "Original composition." }
    ]
  }
};

// ==========================================
// 2. COMPONENTS (CAPITALIZED VideoCard for React)
// ==========================================
...
const Header = () => (
  <div className="relative z-20">
    ...
    <div className="absolute left-8 -bottom-16 flex items-end gap-6">
      <div className="w-32 h-32 rounded-2xl bg-gray-600 border-4 border-[#0a0705] shadow-2xl overflow-hidden flex-shrink-0">
        <div className="w-full h-full bg-gradient-to-br from-gray-400 to-gray-600" />
      </div>
      <div className="pb-4">
        <h1 className="text-3xl font-bold tracking-tight text-white shadow-black drop-shadow-md">Val Sol</h1>
        <p className="text-blue-400 text-lg font-medium shadow-black drop-shadow-md">Sound Designer / Composer</p>
      </div>
    </div>
  </div>
);
...
const NavBar = () => {
  ...
  return (
    <div className="relative z-10 border-b border-white/10 bg-[#0a0705]/80 backdrop-blur-md overflow-x-auto">
...
export default function Portfolio() {
  return (
    <Router>
      <div className="relative min-h-screen text-white font-sans bg-[#0a0705]">
        <Background />
        <Header />
        <NavBar />
