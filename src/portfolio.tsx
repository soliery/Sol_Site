...
The video below offers a brief overview of the implementation in Wwise.`
  ...
  "/music": {
    ...
    videos: [
      ...
      { title: "Forest Story", video: "https://www.youtube.com/embed/lJ6JMFQ95LA", description: "Music created for an unannounced project. The video was generated by AI, inspired by the story by Sterling Lanier." }
